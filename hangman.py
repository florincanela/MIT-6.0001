...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while guesses > 0 and progress != secret_word:
      ...
      if not guess.isalpha():
        if warnings:
          warnings -= 1
          print(f"Oops! That is not a valid letter. You have {warnings} warnings left: {progress}")
      
        else:
          guesses -= 1
          print(f"Oops! That is not a valid letter. You have no warnings left so you lose one guess: {progress}")
          

        continue
      # ==============================================

      #       GUESS is ON letters_guessed

      elif guess in letters_guessed:
        if warnings:
          warnings -= 1
          print(f"Oops! You've already guessed that letter. You have {warnings} warnings left: {progress}")
        else:
          guesses -= 1
          print(f"Oops! You've already guessed that letter. You have no warnings left so you lose one guess: {progress}")
        continue
